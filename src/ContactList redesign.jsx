...
const ContactTableRedesign = () => {
  ...
  const deleteContact = (phone) => {
    console.log("this is the phone to be deleted", phone);
    axios
      .delete(
        `https://z6lnh50aua.execute-api.us-east-2.amazonaws.com/dev/deleteContact?phone=${phone}`
      )
      .then(function (response) {
        let filteredContacts = contacts.filter((x) => x.phone !== phone);
...
export default ContactTableRedesign;
